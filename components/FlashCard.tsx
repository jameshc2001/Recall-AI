...
export default function FlashCard({ question, answer, isFlipped, onFlip }: Props) {
  return (
    ...
    >
      ...
      >
        {/* Front — question */}
        <div className="absolute inset-0 [backface-visibility:hidden] bg-white border border-neutral-200 rounded-2xl flex flex-col items-center justify-center p-8 shadow-sm dark:bg-neutral-800 dark:border-neutral-700">
          <span className="text-xs font-medium text-neutral-400 uppercase tracking-wider mb-4">Question</span>
          <p className="text-lg text-center text-neutral-800 font-medium leading-relaxed dark:text-neutral-100">{question}</p>
