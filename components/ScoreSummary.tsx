...
export default function ScoreSummary({ results, deckTitle, onRestart }: Props) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full gap-6 text-center p-5 sm:p-8">
      <div>
      ...
      <div className="flex gap-5 sm:gap-8">
        <div className="flex flex-col items-center">
          <span className="text-2xl sm:text-3xl font-bold text-green-500">{correct}</span>
          <span className="text-xs text-neutral-400 mt-1">Correct</span>
        </div>
        <div className="flex flex-col items-center">
          <span className="text-2xl sm:text-3xl font-bold text-red-400">{total - correct}</span>
          <span className="text-xs text-neutral-400 mt-1">Incorrect</span>
        </div>
        <div className="flex flex-col items-center">
          <span className="text-2xl sm:text-3xl font-bold text-neutral-700 dark:text-neutral-300">{pct}%</span>
